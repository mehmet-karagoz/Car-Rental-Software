...
<body>
      ...
      <div class="card" id="formCard">
        <div class="card-body">
          <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <div class="dropdown returnDropdown" id="returnDropdown" style="display: none">
              <i class="fa-solid fa-location-dot"></i>
      ...
      <div class="row">
        ...
        <div class="col-lg-4 col-md-6">
          <div class="service-item">
            <a href="#" class="services-item-image"><img src="../images/product-1-370x270.jpg" class="img-fluid" alt="" /></a>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="service-item">
            <a href="#" class="services-item-image"><img src="../images/product-2-370x270.jpg" class="img-fluid" alt="" /></a>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="service-item">
            <a href="#" class="services-item-image"><img src="../images/product-3-370x270.jpg" class="img-fluid" alt="" /></a>
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($_POST["pick-up-date"] > $date_now && $_POST["return-date"] > $date_now && $_POST["return-date"] > $_POST["pick-up-date"]) {
